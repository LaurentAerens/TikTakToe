...
internal static class BoardEvaluationPrimitives
{
    public static int EvaluateTerminalState(int[,] board)
    {
        // Fast center-first checks for diagonal and center-based row/column wins.
        if (board[1, 1] == 1 &&
            (
